...
export const EN_LK: Subject = { name: "En LK", aliases: ["lk-en", "lk-eng", "eng"] };
...
export const MA_LK: Subject = { name: "Ma LK", aliases: ["lk-ma", "ma"] };
export const MA_GK: Subject = { name: "Ma GK", aliases: ["gk-ma", "ma"] };
...
export const LF_8: Subject = { name: "LF 8", aliases: ["lf8d_i1", "lf8d_i2"] };
export const LF_9_12: Subject = { name: "LF 9+12" };
export const LF_10: Subject = { name: "LF 10", aliases: ["lf10d_i1", "lf10d_i2"] };
export const LF_11: Subject = { name: "LF 11", aliases: ["lf11d_i1", "lf11d_i2"] };
