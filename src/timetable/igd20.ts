...
export const IGD20: Timetable = {
  ...
  tue: [
    ...
    { time: BLOCK_3, subject: LF_11, place: "A 303", group: 1 },
    { time: BLOCK_3, subject: LF_8, place: "A 203", group: 2 },
    { time: BLOCK_4, subject: LF_8_X, place: "B 3" },
  ],
  wed: [
    { time: BLOCK_1, subject: LF_6_7_9, place: "B 105" },
  ...
  fri: [
    ...
    { time: BLOCK_3, subject: GE, place: "B 414" },
    { time: BLOCK_4, subject: LF_8, place: "A 202", group: 1 },
    { time: BLOCK_4, subject: LF_11, place: "A 303", group: 2 },
  ],
};
